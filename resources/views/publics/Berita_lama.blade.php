...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('view_berita.css') }}">
  </head>
  <body>
        ...
        <div class="data">
            ...
            <div class="d-flex mb-3">
                <div class="flex-shrink-0">
                  <img src="{{asset('storage/image/'.$item->foto)}}" alt="Dokumentasi" id="view">
                </div>
                <div class="flex-grow-1 ms-3">
                    ...
                    <p class="limit">{{ Str::limit(Strip_tags($item['isi']), 100,".....") }}</p>
                </div>
              </div>
              <hr>
            @empty
