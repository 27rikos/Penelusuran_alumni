...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('lowongan.css') }}">
  </head>
  <body>
        ...
        <div class="row">
          ...
          <div class="d-flex">
            <div class="flex-grow-1 ms-3">
             <div class="card mb-3">
              <div class="my-3 mx-3">
                <a href="/pdf/{{ $item->id }}" >{{ $item->file }}</a>
              <p class=" text-body-secondary"><i class="fa-solid fa-calendar-days fa-sm me-3"></i> {{ $item->created_at }}</p>
              <p class=" text-secondary"><label for="">Pengirim :</label> {{ $item->pengirim }}</p>
              <ul style="list-style: none" class="text-secondary">
                <li><p class="card-text"><i class="fa-regular fa-envelope me-2"></i>{{ $item->email }}</p></li>
                <li><p class="card-text"><i class="fa-solid fa-phone me-2"></i>{{ $item->hp }}</p></li>
              </ul>
              </div>
             </div>
            </div>
