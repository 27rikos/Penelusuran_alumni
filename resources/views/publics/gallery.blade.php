      ...
      <div class="container mt-5">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-xs-6">
            <a   data-fancybox="gallery" href="{{ asset('storage/gallery/'.$item->foto) }}" class="d-block mb-4 h-100">
                  <img class="img-fluid img-thumbnail" src="{{ asset('storage/gallery/'.$item->foto) }}" id="foto">
                </a>
          </div>
          @empty
